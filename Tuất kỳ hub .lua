-- ==========================================================
-- ⚡ TUẤT KỲ HUB ⚡ - ULTRA NEON CYBER EDITION (4 SCRIPTS)
-- ==========================================================

-- Danh sách URL Scripts
...
local voidShellScriptURL = "https://raw.githubusercontent.com/VoidShell-null/VoidShell-Hub/refs/heads/main/Scripts/StealAnEgg.luau"

-- Tự động xóa Gui cũ nếu đã tồn tại
...
------------------------------------------------------------------
-- 2. KHUNG MENU CHÍNH (MAIN FRAME - TĂNG CHIỀU CAO CHO 4 NÚT)
------------------------------------------------------------------
...
MainFrame.Visible = false -- Ban đầu ẩn, bấm nút tròn để bật
...
LemonBtn.Position = UDim2.new(0.08, 0, 0.16, 0)
LemonBtn.Size = UDim2.new(0.84, 0, 0, 48)
...
MirandaBtn.Position = UDim2.new(0.08, 0, 0.36, 0)
MirandaBtn.Size = UDim2.new(0.84, 0, 0, 48)
...
-- Nút 3: VoidShell Hub (MỚI THÊM)
local VoidBtn = Instance.new("TextButton")
VoidBtn.Name = "VoidBtn"
VoidBtn.Parent = MainFrame
VoidBtn.BackgroundColor3 = Color3.fromRGB(0, 140, 220)
VoidBtn.Position = UDim2.new(0.08, 0, 0.56, 0)
VoidBtn.Size = UDim2.new(0.84, 0, 0, 48)
VoidBtn.Font = Enum.Font.SourceSansBold
VoidBtn.Text = "🌌 VoidShell Hub (Steal Egg)"
VoidBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
VoidBtn.TextSize = 15.000

local VoidCorner = Instance.new("UICorner")
VoidCorner.CornerRadius = UDim.new(0, 10)
VoidCorner.Parent = VoidBtn

-- Nút 4: Rubu Hop Server
...
RubuBtn.Position = UDim2.new(0.08, 0, 0.76, 0)
RubuBtn.Size = UDim2.new(0.84, 0, 0, 48)
...
-- Execute VoidShell Hub
VoidBtn.MouseButton1Click:Connect(function()
    VoidBtn.Text = "⏳ Đang tải VoidShell..."
    local success, err = pcall(function()
        loadstring(game:HttpGet(voidShellScriptURL))()
    end)
    if success then
        VoidBtn.Text = "✅ Đã chạy VoidShell!"
    else
        VoidBtn.Text = "❌ Lỗi kết nối!"
        warn("Lỗi VoidShell Hub:", err)
    end
    task.wait(2)
    VoidBtn.Text = "🌌 VoidShell Hub (Steal Egg)"
end)
